...
const Charac_tr_InsertStr = "\"ark_id\", \"name\", \"description\""
const Charac_tr_InsertValuesStr = ":ark_id, :name, :description"
const Charac_tr_UpdateStr = "\"ark_id\" = :ark_id, \"name\" = :name, \"description\" = :description"
