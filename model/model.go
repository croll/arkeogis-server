...
type Group struct {
	...
	Created_at time.Time `db:"created_at" json:"created_at"`
	Updated_at time.Time `db:"udpated_at" json:"udpated_at"`
}
...
const Group_InsertStr = "\"type\", \"created_at\", \"udpated_at\""
const Group_InsertValuesStr = ":type, now(), :udpated_at"
const Group_UpdateStr = "\"type\" = :type, \"udpated_at\" = :udpated_at"
