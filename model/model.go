...
type User struct {
	Id             int       `db:"id" json:"id"`
	Username       string    `db:"username" json:"username" min:"2" max:"32"`
...
const Database_translation_InsertStr = "\"description\", \"geographical_limit\", \"bibliography\""
const Database_translation_InsertValuesStr = ":description, :geographical_limit, :bibliography"
const Database_translation_UpdateStr = "\"description\" = :description, \"geographical_limit\" = :geographical_limit, \"bibliography\" = :bibliography"
