...
const Lang_InsertStr = "\"isocode\", \"active\""
const Lang_InsertValuesStr = ":isocode, :active"
const Lang_UpdateStr = "\"isocode\" = :isocode, \"active\" = :active"
...
const Chronology_tr_InsertStr = "\"lang_isocode\", \"name\", \"description\""
const Chronology_tr_InsertValuesStr = ":lang_isocode, :name, :description"
const Chronology_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"description\" = :description"
...
const Database_tr_InsertStr = "\"lang_isocode\", \"description\", \"geographical_limit\", \"bibliography\", \"context_description\", \"source_description\", \"source_relation\", \"copyright\", \"subject\""
const Database_tr_InsertValuesStr = ":lang_isocode, :description, :geographical_limit, :bibliography, :context_description, :source_description, :source_relation, :copyright, :subject"
const Database_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"description\" = :description, \"geographical_limit\" = :geographical_limit, \"bibliography\" = :bibliography, \"context_description\" = :context_description, \"source_description\" = :source_description, \"source_relation\" = :source_relation, \"copyright\" = :copyright, \"subject\" = :subject"
...
const Site_tr_InsertStr = "\"lang_isocode\", \"description\""
const Site_tr_InsertValuesStr = ":lang_isocode, :description"
const Site_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"description\" = :description"
...
const Site_range__charac_tr_InsertStr = "\"lang_isocode\", \"comment\", \"bibliography\""
const Site_range__charac_tr_InsertValuesStr = ":lang_isocode, :comment, :bibliography"
const Site_range__charac_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"comment\" = :comment, \"bibliography\" = :bibliography"
const City_tr_InsertStr = "\"lang_isocode\", \"name\", \"name_ascii\""
const City_tr_InsertValuesStr = ":lang_isocode, :name, :name_ascii"
const City_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"name_ascii\" = :name_ascii"
const Charac_tr_InsertStr = "\"lang_isocode\", \"name\", \"description\""
const Charac_tr_InsertValuesStr = ":lang_isocode, :name, :description"
const Charac_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"description\" = :description"
...
const Wms_map_InsertStr = "\"creator_user_id\", \"url\", \"source_creation_date\", \"min_scale\", \"max_scale\", \"start_date\", \"end_date\", \"geographical_extent_geom\", \"published\", \"created_at\", \"updated_at\""
const Wms_map_InsertValuesStr = ":creator_user_id, :url, :source_creation_date, :min_scale, :max_scale, :start_date, :end_date, :geographical_extent_geom, :published, now(), now()"
const Wms_map_UpdateStr = "\"creator_user_id\" = :creator_user_id, \"url\" = :url, \"source_creation_date\" = :source_creation_date, \"min_scale\" = :min_scale, \"max_scale\" = :max_scale, \"start_date\" = :start_date, \"end_date\" = :end_date, \"geographical_extent_geom\" = :geographical_extent_geom, \"published\" = :published, \"updated_at\" = now()"
const Wms_map_tr_InsertStr = "\"lang_isocode\", \"name\", \"attribution\", \"copyright\""
const Wms_map_tr_InsertValuesStr = ":lang_isocode, :name, :attribution, :copyright"
const Wms_map_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"attribution\" = :attribution, \"copyright\" = :copyright"
const Shapefile_InsertStr = "\"creator_user_id\", \"source_creation_date\", \"filename\", \"geom\", \"min_scale\", \"max_scale\", \"start_date\", \"end_date\", \"geographical_extent_geom\", \"published\", \"license_name\", \"odbl_license\", \"created_at\", \"updated_at\""
const Shapefile_InsertValuesStr = ":creator_user_id, :source_creation_date, :filename, :geom, :min_scale, :max_scale, :start_date, :end_date, :geographical_extent_geom, :published, :license_name, :odbl_license, now(), now()"
const Shapefile_UpdateStr = "\"creator_user_id\" = :creator_user_id, \"source_creation_date\" = :source_creation_date, \"filename\" = :filename, \"geom\" = :geom, \"min_scale\" = :min_scale, \"max_scale\" = :max_scale, \"start_date\" = :start_date, \"end_date\" = :end_date, \"geographical_extent_geom\" = :geographical_extent_geom, \"published\" = :published, \"license_name\" = :license_name, \"odbl_license\" = :odbl_license, \"updated_at\" = now()"
const Shapefile_tr_InsertStr = "\"lang_isocode\", \"name\", \"description\", \"attribution\", \"bibiography\""
const Shapefile_tr_InsertValuesStr = ":lang_isocode, :name, :description, :attribution, :bibiography"
const Shapefile_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"description\" = :description, \"attribution\" = :attribution, \"bibiography\" = :bibiography"
...
const Group_tr_InsertStr = "\"lang_isocode\", \"name\", \"description\""
const Group_tr_InsertValuesStr = ":lang_isocode, :name, :description"
const Group_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"description\" = :description"
const Permission_tr_InsertStr = "\"lang_isocode\", \"name\", \"description\""
const Permission_tr_InsertValuesStr = ":lang_isocode, :name, :description"
const Permission_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"description\" = :description"
...
const Country_tr_InsertStr = "\"lang_isocode\", \"name\", \"name_ascii\""
const Country_tr_InsertValuesStr = ":lang_isocode, :name, :name_ascii"
const Country_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"name_ascii\" = :name_ascii"
...
const Continent_tr_InsertStr = "\"lang_isocode\", \"name\", \"name_ascii\""
const Continent_tr_InsertValuesStr = ":lang_isocode, :name, :name_ascii"
const Continent_tr_UpdateStr = "\"lang_isocode\" = :lang_isocode, \"name\" = :name, \"name_ascii\" = :name_ascii"
